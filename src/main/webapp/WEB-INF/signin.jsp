...
<div class="navbar">
    <div class="container flex">
        <!-- Image Logo -->
        <a class="logo-image" href="index.jsp"><span style="color: #5e9693;">MY</span><span style="color: #fff;">TODO</span></a>
...
<div class="page" style="margin-top: 30px">
    <div class="container">
        <div class="left">
            <div class="login">S'inscrire</div>
            <div class="eula"><span>Connectez vous pour savoir vos taches à faire</span>
                <br>
            <a href="/LoginServlet">Vous avez dèja un compte?</a></div>
        </div>
        <div class="right">
            ...
            <div class="form">
                <form method="post" action="SigninServlet">
                    ...
                    <input type="submit" id="submit" value="S'enregister">
                </form>
            </div>
        </div>
    </div>
